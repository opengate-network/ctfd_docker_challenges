...
class DockerChallengeType(BaseChallenge):
    ...
    name = "docker"
    templates = {
        'create': '/plugins/ctfd_docker_challenges/assets/create.html',
        'update': '/plugins/ctfd_docker_challenges/assets/update.html',
        'view': '/plugins/ctfd_docker_challenges/assets/view.html',
    }
    scripts = {
        'create': '/plugins/ctfd_docker_challenges/assets/create.js',
        'update': '/plugins/ctfd_docker_challenges/assets/update.js',
        'view': '/plugins/ctfd_docker_challenges/assets/view.js',
    }
    route = '/plugins/ctfd_docker_challenges/assets'
    blueprint = Blueprint('ctfd_docker_challenges', __name__, template_folder='templates', static_folder='assets')
...
def load(app):
    ...
    register_plugin_assets_directory(app, base_path='/plugins/ctfd_docker_challenges/assets')
